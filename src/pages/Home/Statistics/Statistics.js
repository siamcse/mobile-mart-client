...
const Statistics = () => {
    return (
        <section className="p-6 my-6 bg-gray-100 container">
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                <div className="flex p-4 space-x-4 bg-white rounded-lg md:space-x-6 shadow-xl">
                ...
                <div className="flex p-4 space-x-4 bg-white rounded-lg md:space-x-6 shadow-xl">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        ...
                        <p className="capitalize">On Time Delivery</p>
                    </div>
                </div>
                <div className="flex p-4 space-x-4 bg-white rounded-lg md:space-x-6 shadow-xl">
                    <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4">
                    ...
                    <div className="flex flex-col justify-center align-middle">
                        <p className="text-3xl font-semibold leading-none">Pay</p>
                        <p className="capitalize">Book Now</p>
                    </div>
                </div>
            </div>
        </section>
