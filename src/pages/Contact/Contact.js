        ...
        <section class="py-10 bg-gray-100 sm:py-16 lg:py-24">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="max-w-2xl mx-auto text-center">
                    ...
                    <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">You can contact us for any query. If your product is damaged or other problem you can contact with us.</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                        <div class="overflow-hidden bg-white rounded-xl">
                            <div class="p-6">
                                ...
                                <p class="mt-6 text-lg font-medium text-gray-900 flex items-center justify-center gap-2"><span><IoLogoWhatsapp className='text-green-500' /></span>+880-196-0112553 </p>
                                <p class="mt-1 text-lg font-medium text-gray-900">+880-151-8331057</p>
                            </div>
                        </div>
                        ...
                        <div class="overflow-hidden bg-white rounded-xl">
                            <div class="p-6">
                                ...
                                <p class="mt-6 text-lg font-medium text-gray-900">abusiam06@gmail.com</p>
                                <p class="mt-1 text-lg font-medium text-gray-900">siamcse01@gmail.com</p>
                            </div>
                        </div>
                        ...
                        <div class="overflow-hidden bg-white rounded-xl">
                            <div class="p-6">
                                ...
                                <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">Shailer Kanda 2205, Itail, Jamalpur Sadar, Bangladesh</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 py-12 sm:p-12">
                            ...
                            <form action="#" method="POST" class="mt-14">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                                    ...
                                    <div class="sm:col-span-2">
                                        <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-base font-semibold text-white transition-all duration-200 bg-primary border border-transparent rounded-md focus:outline-none hover:bg-red-700 focus:bg-blue-700">
                                            Send
                                        </button>
                                    </div>
                                </div>
